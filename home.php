...
<body>
    ...
    <div class="landing">
        <div>
            <h1 class="animate__animated animate__fadeInDown">Welcome to Our electronics Shop</h1>
            <p class="animate__animated animate__fadeInUp">Best Products, Best Services</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <section class="who-we-are">
            ...
            <p class="text-center">We are a leading electronics shop offering the best prices and services in town. Our mission is to provide our customers with high-quality products and exceptional customer service.</p>
        </section>
        ...
        <section class="features">
            <div class="row text-center">
                ...
                <div class="col-md-4">
                    ...
                    <p>We offer a wide selection of the latest products and accessories at competitive prices.</p>
                </div>
            </div>
        </section>
